""" This module implements a pretrained ResNet50
with a three channel input (3 different MRI slice scan types).
It trains, validates and tests a ResNet50 classification
...
def main():
    ...
    results_path = "E:\\data\\output\\results\\resnet50_scantype_pretrained_multi"
    save_file = "E:\\data\\output\\nets\\resnet50_scantype_pretrained_multi.pth"
    file_name = "resnet50_scantype_pretrained_multi.txt"
    folder = "resnet50_scantype_pretrained_multi"
