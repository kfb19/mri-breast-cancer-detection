...
def main():
    ...
    results_path = "E:\\data\\output\\results\\resnet50_scantype_multi"
    save_file = "E:\\data\\output\\nets\\resnet50_scantype_multi.pth"
    file_name = "resnet50_scantype_multi.txt"
    folder = "resnet50_scantype_multi"
