""" This module implements VGG19 with a single
...
def main():
    ...
    results_path = "E:\\data\\output\\results\\vgg_single_multi"
    save_file = "E:\\data\\output\\nets\\vgg_single_multi.pth"
    file_name = "vgg_single_multi.txt"
    folder = "vgg_single_multi"
