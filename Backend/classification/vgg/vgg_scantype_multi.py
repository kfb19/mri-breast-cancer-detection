""" This module implements VGG19 with a three
...
def main():
    ...
    results_path = "E:\\data\\output\\results\\vgg_scantype_multi"
    save_file = "E:\\data\\output\\nets\\vgg_scantype_multi.pth"
    file_name = "vgg_scantype_multi.txt"
    folder = "vgg_scantype_multi"
