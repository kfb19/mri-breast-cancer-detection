""" This module implements DenseNet201 with a single
...
def main():
    ...
    results_path = "F:\\data\\output\\results\\densenet_single_multi"
    save_file = "F:\\data\\output\\nets\\densenet_single_multi.pth"
    file_name = "densenet_single_multi.txt"
    folder = "densenet_single_multi"
