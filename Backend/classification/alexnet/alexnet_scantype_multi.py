...
def main():
    ...
    results_path = "E:\\data\\output\\results\\alexnet_scantype_multi"
    save_file = "E:\\data\\output\\nets\\alexnet_scantype_multi.pth"
    file_name = "alexnet_scantype_multi.txt"
    folder = "alexnet_scantype_multi"
