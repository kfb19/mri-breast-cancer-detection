""" This module implements AlexNet with a single
input channel (as images are greyscale). It trains,
validates and tests a AlexNet classification CNN
...
def main():
    """ Runs the bulk of the CNN code.
        Implements AlexNet with single-channel input.
        """

    # Directory information.
    data_dir = 'E:\\data\\output\\bmp_out_single_classify'
    results_path = "E:\\data\\output\\results\\alexnet_single_pretrained_multi"
    save_file = "E:\\data\\output\\nets\\alexnet_single_pretrained_multi.pth"
    file_name = "alexnet_single_pretrained_multi.txt"
    folder = "alexnet_single_pretrained_multi"
