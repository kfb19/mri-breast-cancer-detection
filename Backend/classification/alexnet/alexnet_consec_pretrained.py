...
def main():
    ...
    results_path = "F:\\data\\output\\results\\alexnet_consec_pretrained"
    save_file = "F:\\data\\output\\nets\\alexnet_consec_pretrained.pth"
    file_name = "alexnet_consec_pretrained.txt"
    folder = "alexnet_consec_pretrained"
